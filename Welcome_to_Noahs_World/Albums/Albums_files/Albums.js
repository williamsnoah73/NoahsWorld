...
{return IWCreateMediaCollection("http://noahwilliams.me/Welcome_to_Noahs_World/Albums/Albums_files/rss.xml",true,255,["No photos yet","%d photo","%d photos"],["","%d clip","%d clips"]);}
function initializeMediaStream_id3()
{createMediaStream_id3().load('http://noahwilliams.me/Welcome_to_Noahs_World/Albums',function(imageStream)
